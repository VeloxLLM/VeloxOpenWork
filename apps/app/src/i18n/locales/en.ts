 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, VeloxOpenWork) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "VeloxOpenWork server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "VeloxOpenWork server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "composer.no_mcps": "No MCP servers in this workspace.",
  "composer.no_connections": "No connections available.",
  "composer.no_connections_mcps": "No connections or MCP servers yet.",
  "composer.no_plugins": "No plugins in your Library yet.",
  "composer.no_plugin_files": "This plugin has no skills or commands yet.",
  ...
  "connect.connected_to_cloud": "Connected to VeloxOpenWork Cloud",
  "connect.connected_to_org": "Connected to {name}",
  "connect.diagnostics_action_label": "Recommended action",
  "connect.diagnostics_agent_description": "Redacted evidence from the server-computed VeloxOpenWork agent configuration intent. Effective engine state was not observed.",
  "connect.diagnostics_agent_description_effective": "Redacted evidence from the effective engine-resolved VeloxOpenWork agent and its context markers.",
  ...
  "connect.diagnostics_check_agent_resolution": "VeloxOpenWork agent configuration intent",
  "connect.diagnostics_check_agent_resolution_effective": "Effective VeloxOpenWork agent resolution",
  "connect.diagnostics_check_cloud_endpoint_differential": "Runtime probe vs engine verdict",
  "connect.diagnostics_check_cloud_endpoint_transport": "VeloxOpenWork Cloud endpoint transport",
  "connect.diagnostics_check_cloud_tool_catalog": "VeloxOpenWork Cloud tool catalog",
  ...
  "connect.diagnostics_global_cloud_mcp": "Global VeloxOpenWork Cloud MCP",
  ...
  "connect.diagnostics_mcp_description_effective": "The engine's merged configuration and VeloxOpenWork-managed dynamic injection intent are shown separately. Runtime rows include exact registration outcomes; this is not a complete live tool-registry snapshot.",
  ...
  "connect.diagnostics_org_description": "These connections operate behind the single VeloxOpenWork Cloud meta-MCP and are not injected as separate engine MCPs.",
  ...
  "connect.diagnostics_owner_openwork_client": "VeloxOpenWork client",
  "connect.diagnostics_owner_openwork_server": "VeloxOpenWork server",
  "connect.diagnostics_owner_openwork_support": "VeloxOpenWork support",
  ...
  "connect.diagnostics_configured_agent": "Configured VeloxOpenWork agent",
  "connect.diagnostics_effective_agent": "Effective VeloxOpenWork agent",
  "connect.diagnostics_agent_state": "VeloxOpenWork agent state",
  ...
  "connect.diagnostics_unavailable_direct_opencode": "For privacy, agent diagnostics are unavailable for direct remote OpenCode workspaces. Use a remote VeloxOpenWork workspace to run this report.",
  "connect.diagnostics_workspace_cloud_mcp": "Selected workspace VeloxOpenWork Cloud MCP",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from VeloxOpenWork Den.",
  ...
  "connect.pitch_title": "Connect is the new way VeloxOpenWork lets you share workflows with your team.",
  ...
  "connect.state_not_configured_action": "Sign in to VeloxOpenWork Cloud to finish setup.",
  ...
  "connect.state_unavailable_action": "Restart VeloxOpenWork. If this continues, run diagnostics.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected VeloxOpenWork servers.",
  ...
  "config.server_needed_hint": "VeloxOpenWork server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an VeloxOpenWork server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "VeloxOpenWork server",
  ...
  "config.server_sharing_title": "VeloxOpenWork server sharing",
  "config.server_url_hint": "Use the URL shared by your VeloxOpenWork server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "VeloxOpenWork server URL",
  "config.server_url_label": "VeloxOpenWork Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable VeloxOpenWork server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "VeloxOpenWork server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "VeloxOpenWork server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "VeloxOpenWork server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable VeloxOpenWork server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted VeloxOpenWork worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted VeloxOpenWork worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an VeloxOpenWork server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the VeloxOpenWork server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted VeloxOpenWork worker.",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update VeloxOpenWork and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and VeloxOpenWork will reconnect here automatically.",
  ...
  "den.cloud_provider_needs_server": "Needs VeloxOpenWork server",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access VeloxOpenWork Cloud.",
  "den.cloud_section_title": "VeloxOpenWork Cloud",
  "den.cloud_sleep_hint": "Sign in to VeloxOpenWork Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use VeloxOpenWork Cloud.",
  "den.open_dashboard": "Open Den dashboard",
  "den.cloud_unavailable_body": "Local work remains available. Reconnecting automatically.",
  "den.cloud_unavailable_title": "VeloxOpenWork Cloud is temporarily unavailable.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but VeloxOpenWork Cloud did not return a session token.",
  "den.error_paste_valid_code": "Paste a valid VeloxOpenWork sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete VeloxOpenWork Cloud sign-in.",
  ...
  "den.error_signout_failed": "Could not sign out of VeloxOpenWork Cloud. Try again.",
  ...
  "den.signin_link_hint": "If your browser doesn't bounce back into VeloxOpenWork automatically, paste the sign-in link or one-time code from VeloxOpenWork Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "openwork://den-auth?... or pasted code",
  "den.signin_title": "Sign in to VeloxOpenWork Cloud",
  "den.signing_in": "Finishing VeloxOpenWork Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect VeloxOpenWork.",
  "den.status_browser_signin_paste": "Sign in in your browser, copy the VeloxOpenWork link, then paste it below.",
  "den.status_browser_signup": "Finish account creation in your browser to connect VeloxOpenWork.",
  "den.status_browser_signup_paste": "Create your account in the browser, copy the VeloxOpenWork link, then paste it below.",
  "den.status_cloud_signed_in_as": "Connected VeloxOpenWork Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected VeloxOpenWork Cloud.",
  ...
  "den.status_signed_out": "Signed out and cleared your VeloxOpenWork Cloud session on this device.",
  "den.status_server_config_cleared": "Cleared the desktop server configuration. VeloxOpenWork is using the default Cloud control plane.",
  ...
  "extensions.add_skill": "Add skill",
  "extensions.add_command": "Add command",
  "extensions.add_agent": "Add agent",
  "extensions.add_mcp": "Add MCP",
  "extensions.add_plugin": "Add plugin",
  "extensions.add_connection": "Add connection",
  "extensions.add_create": "Create",
  "extensions.create_skill_title": "Create a skill",
  "extensions.create_command_title": "Create a command",
  "extensions.create_agent_title": "Create an agent",
  "extensions.create_plugin_title": "Create a plugin",
  "extensions.create_skill_hint": "Saved to your organization Library. Agents can load these instructions from VeloxOpenWork Cloud.",
  "extensions.create_command_hint": "Saved to your organization Library as a slash command.",
  "extensions.create_agent_hint": "Saved to your organization Library as a named agent.",
  "extensions.create_plugin_hint": "Bundle skills, commands, and MCP servers in your organization Library.",
  "extensions.create_mcp_title": "Add an MCP server",
  "extensions.create_mcp_hint": "Saved to your organization Library as a remote MCP connection.",
  "extensions.create_mcp_submit": "Add MCP",
  "extensions.add_mcp_url_label": "Server URL",
  "extensions.add_mcp_url_hint": "HTTPS URL for the remote MCP server.",
  "extensions.add_mcp_url_required": "MCP server URL is required.",
  "extensions.add_name_hint_mcp": "Shown in Library and the composer",
  "extensions.add_sign_in_required": "Sign in to VeloxOpenWork Cloud to add items to Library.",
  ...
  "extensions.add_modal_hint_cloud": "Saved to your organization Library and available in the composer.",
  "extensions.add_name_label": "Name",
  "extensions.add_plugin_name_label": "Plugin name",
  "extensions.add_plugin_name_placeholder": "e.g. Sales call prep",
  "extensions.add_plugin_description_placeholder": "What does this plugin help people do?",
  "extensions.add_plugin_inside": "What's inside",
  "extensions.add_plugin_inside_empty": "Add a skill, command, or MCP server to get started. A plugin needs at least one component.",
  "extensions.add_plugin_share": "Share",
  "extensions.add_plugin_share_org": "Share with everyone in the organization",
  "extensions.add_plugin_share_org_hint": "Members can see and install this plugin. Uncheck to keep it private to you while you iterate.",
  "extensions.add_plugin_collection": "Collection",
  "extensions.add_plugin_collection_none": "Don't publish yet",
  "extensions.add_plugin_collection_hint": "Publishing puts the plugin in the collection so members find it in the VeloxOpenWork app.",
  "extensions.add_plugin_component_required": "Add at least one skill, command, or MCP server.",
  "extensions.add_plugin_component_incomplete": "Every component needs a name and content.",
  "extensions.add_component_description_placeholder": "One-line description — when should the agent use this?",
  "extensions.add_description_label": "Description",
  "extensions.add_instructions_label": "Instructions",
  "extensions.add_skill_body_label": "Skill body",
  "extensions.add_skill_body_hint": "Markdown is stored and displayed in full.",
  ...
  "extensions.add_unauthorized": "Your VeloxOpenWork Cloud session expired. Sign in again, then create the skill.",
  "extensions.add_name_hint_skill": "Lowercase kebab-case, for example briefing-notes",
  "extensions.add_name_hint_command": "Used as a slash command, for example /release",
  "extensions.add_name_hint_agent": "Shown in the composer agent list",
  "extensions.add_name_hint_plugin": "Holds skills, commands, and MCP servers for your organization",
  "extensions.add_name_required": "Name is required.",
  "extensions.add_description_required": "Description is required.",
  "extensions.add_instructions_required": "Instructions are required.",
  "extensions.add_slug_preview": "Will be saved as {slug}",
  ...
  "extensions.empty_connections": "{org} has not shared any connections with you yet. An admin adds them in the VeloxOpenWork Cloud dashboard.",
  "extensions.empty_connections_signed_out": "Connections are shared by your organization. Sign in to VeloxOpenWork Cloud from Account to see yours.",
  ...
  "extensions.detail_fact_capabilities": "Capabilities",
  "extensions.detail_fact_account": "Account",
  ...
  "extensions.marketplace_description": "Browse VeloxOpenWork built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through VeloxOpenWork Cloud, while GitHub and Claude plugin imports live in local Library.",
  ...
  "extensions.surface_cloud": "VeloxOpenWork Cloud",
  ...
  "mcp.toggle_requires_server": "Connect to an VeloxOpenWork server to enable or disable MCPs.",
  "mcp.action_reconnect": "Reconnect",
  "mcp.add_modal_subtitle": "Connect a custom MCP to this workspace. This setup stays separate from organization-managed services in VeloxOpenWork Connect.",
  "mcp.add_modal_title": "Add workspace MCP",
  "mcp.add_mcp_description": "Add a local or remote MCP integration.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so VeloxOpenWork can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, VeloxOpenWork needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, VeloxOpenWork needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize VeloxOpenWork",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from VeloxOpenWork.",
  ...
  "mcp.managed_oauth_unavailable": "Secure storage is unavailable on this device, so VeloxOpenWork-managed sign-ins are paused.",
  "mcp.name_required": "Enter a server name.",
  "mcp.name_reserved_openwork_connect": "This name is reserved for VeloxOpenWork Connect. Choose a different name for the workspace MCP.",
  "mcp.no_apps_hint": "Connect one above to get started.",
  "mcp.no_apps_yet": "No apps connected yet",
  "mcp.oauth": "Sign in",
  "mcp.oauth_advanced_hint": "This desktop handles sign-in and token refresh, and encrypts the OAuth credentials in this device's protected app storage. This is separate from VeloxOpenWork Connect and does not connect other devices.",
  ...
  "mcp.oauth_secret_warning": "VeloxOpenWork encrypts these credentials in local app data. They are not written to your workspace or OpenCode configuration. Keep client secrets out of chats and source control.",
  ...
  "mcp.quick_connect_openwork_cloud_title": "VeloxOpenWork Cloud Control",
  "mcp.quick_connect_openwork_ui_desc": "Let agents see and drive the VeloxOpenWork app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_openwork_ui_title": "VeloxOpenWork UI Control",
  ...
  "models.all_models": "All models",
  "models.change_model": "Change model",
  "models.no_models_found": "No models found.",
  "models.search_models": "Search models...",
  "models.select_model": "Select model",
  "notifications.clear_all": "Clear all",
  "notifications.empty": "No notifications yet",
  "notifications.empty_hint": "Updates from VeloxOpenWork Cloud and your workspaces will show up here.",
  "notifications.engine_reloaded": "Updates applied",
  "notifications.just_now": "Just now",
  "notifications.reconnect_failed": "Couldn't reconnect to the VeloxOpenWork server",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. VeloxOpenWork will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// VeloxOpenWork server URL.",
  "welcome.organization_server_link": "Using VeloxOpenWork on-premises?",
  ...
  "welcome.use_cloud": "Use VeloxOpenWork Cloud",
  "welcome.use_cloud_subtitle": "Sign in for hosted VeloxOpenWork and team features",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. VeloxOpenWork will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and VeloxOpenWork can pick them up.",
  ...
  "join_org.confirm_invite_body": "Only continue if you trust {host}. VeloxOpenWork will use it as your organization server and open the invite in your browser.",
  ...
  "join_org.error_invalid": "That does not look like an VeloxOpenWork invite link, install link, server URL, or sign-in code.",
  "join_org.error_invalid_config": "This link opened, but it did not contain a valid VeloxOpenWork organization setup. Ask your admin for a fresh one.",
  "join_org.error_network": "VeloxOpenWork could not reach that organization server. Check your connection or VPN, then try again.",
  ...
  "join_org.invite_opened": "Your invite opened in the browser — finish joining there. VeloxOpenWork now points at {host} and is ready when you come back.",
  "join_org.openwork_cloud": "VeloxOpenWork Cloud",
  ...
  "providers.manual_add_hint": "Add a provider ID, base URL, API key, and one or more model IDs.",
  "providers.manual_edit_title": "Edit model provider",
  "providers.manual_description": "Configure a provider manually. API keys and proxy credentials are encrypted in OS secure storage and are never written to the OpenCode configuration.",
  "providers.connect_provider": "Add a model provider",
  "providers.add_keys": "Add your key",
  "providers.connect_more": "Add another provider",
  "providers.your_api_keys": "Manual providers",
  "providers.manual_name": "Provider name",
  "providers.manual_required": "Provider ID, name, Base URL, and at least one Model ID are required.",
  "providers.manual_save_failed": "Unable to save provider.",
  "providers.manual_test_required": "Enter a Provider ID and Base URL first.",
  "providers.manual_test_success": "Connection successful.",
  "providers.manual_test_failed": "Connection failed.",
  "providers.manual_test": "Test connection",
  "providers.manual_secret_placeholder": "Leave blank to keep the current secret",
  "providers.manual_models_placeholder": "One per line or comma-separated, for example gpt-4o-mini",
  "providers.manual_default_model": "Default Model ID",
  "providers.manual_default_model_placeholder": "Defaults to the first model",
  "providers.manual_proxy_enable": "Enable a provider-specific proxy",
  "providers.manual_proxy_clear": "Clear proxy",
  "providers.manual_proxy_hint": "HTTP/HTTPS only. Proxy credentials are stored securely and never written to OpenCode configuration.",
  "providers.optional_templates": "Optional free-tier templates",
  "providers.invalid_base_url": "Invalid Base URL. Only HTTP/HTTPS endpoints are supported.",
  "providers.invalid_proxy_url": "Invalid proxy URL. Only HTTP/HTTPS proxies are supported.",
  "providers.proxy_url_required": "Enter a proxy URL or disable the provider proxy.",
  "providers.model_required": "Add at least one Model ID.",
  "providers.invalid_global_config": "The global OpenCode configuration is not valid JSON. Fix it before saving a provider.",
  ...
  "session.share_local_host_not_ready": "Local VeloxOpenWork host is not ready yet.",
  "session.share_missing_host_url": "Missing VeloxOpenWork host URL.",
  "session.share_missing_token": "Missing VeloxOpenWork token.",
  ...
  "session.share_openwork_workers_only": "Share service links are available for VeloxOpenWork workers.",
  ...
  "session.hero_title": "What do you need done?",
  "session.engine_unavailable": "OpenCode is unavailable for this workspace. Retry after it restarts, or restart VeloxOpenWork if the problem continues.",
  "session.server_unavailable": "VeloxOpenWork server is unavailable. Start or reconnect the local server before continuing.",
  "session.hero_subtitle": "Describe it in plain language",
  "session.hero_suggestion_1_title": "Summarize my week",
  "session.hero_suggestion_1_description": "Pull highlights from local files and available tools.",
  "session.hero_suggestion_1_prompt": "Summarize my week from the files and tools available in this workspace. Highlight what happened and what needs my attention.",
  "session.hero_suggestion_2_title": "Clean up a spreadsheet",
  "session.hero_suggestion_2_description": "Drop in a CSV and describe the result you want.",
  "session.hero_suggestion_2_prompt": "Create a sample CSV with 20 rows of customer data, then summarize it clearly.",
  "session.hero_suggestion_3_title": "Draft a document",
  "session.hero_suggestion_3_description": "Turn a few bullet points into a report, email, or brief.",
  "session.hero_suggestion_3_prompt": "Draft a one-page project brief. Ask me for the details you need, then produce a clear, well-structured document.",
  "session.hero_suggestion_4_title": "Automate a web task",
  "session.hero_suggestion_4_description": "Use the browser for repetitive steps.",
  "session.hero_suggestion_4_prompt": "Help me automate a repetitive browser task. Ask what site and result I need before starting.",
  ...
  "settings.ai.providers_title": "Model providers",
  "settings.ai.providers_description": "Add providers manually. API keys stay on this device and are not synchronized to a cloud account.",
  "settings.ai.add_provider": "Add provider",
  "settings.ai.disconnect": "Disconnect",
  "settings.ai.empty": "No providers configured. Add one to select a model.",
  ...
  "settings.privacy_section_desc": "Control what VeloxOpenWork shares to improve the product.",
  ...
  "settings.capabilities_title": "VeloxOpenWork server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point VeloxOpenWork at a local OpenCode build",
  ...
  "settings.debug_openwork_server_version": "VeloxOpenWork server: {version}",
  ...
  "settings.runtime_config_one_writer_rule": "VeloxOpenWork writes only the managed runtime config file; user OpenCode config stays user-owned.",
  ...
  "settings.runtime_config_no_removed_keys": "No VeloxOpenWork-managed keys removed.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which VeloxOpenWork events can appear as native operating system notifications.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by VeloxOpenWork. Off by default.",
  ...
  "settings.feedback_title": "Help shape VeloxOpenWork",
  ...
  "settings.open_deeplink_desc": "Paste an VeloxOpenWork deeplink or share URL to open it.",
  ...
  "settings.organization_server_default": "Using standard VeloxOpenWork Cloud.",
  "settings.organization_server_desc": "Point VeloxOpenWork at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's VeloxOpenWork server URL. Saving signs you out so VeloxOpenWork can re-hydrate against that server.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by VeloxOpenWork.",
  ...
  "settings.openwork_config_sidecar_desc": "Local VeloxOpenWork server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.openwork_diagnostics_title": "VeloxOpenWork server diagnostics",
  "settings.openwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openwork_server_label": "VeloxOpenWork server",
  ...
  "settings.quit_hint": "VeloxOpenWork quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect VeloxOpenWork server.",
  "settings.reconnected": "Reconnected to VeloxOpenWork server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears VeloxOpenWork cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears VeloxOpenWork cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. VeloxOpenWork will restart.",
  ...
  "settings.reset_onboarding_description": "Clears VeloxOpenWork preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears VeloxOpenWork local preferences and workspace onboarding markers.",
  ...
  "settings.reset_openwork_title": "Reset VeloxOpenWork + OpenCode state",
  ...
  "settings.restart_blocked_message": "The update is ready, but VeloxOpenWork will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_openwork_server": "Restart VeloxOpenWork server",
  ...
  "settings.services_section_desc": "Local services that power this VeloxOpenWork session. Each service has its own restart and logs.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs VeloxOpenWork will use after local overrides and bootstrap files are applied.",
  ...
  "settings.runtime_desc": "Status for your local engine and VeloxOpenWork server.",
  ...
  "settings.tab_connect": "VeloxOpenWork Connect",
  ...
  "settings.tab_description_appearance": "Adjust how VeloxOpenWork looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_cloud_marketplaces": "Browse your organization's collections of plugins and import them into your workspace.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected VeloxOpenWork workspace plus its runtime connection.",
  ...
  "settings.environment.override_hint": "Environment variables set before VeloxOpenWork starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "VeloxOpenWork will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "VeloxOpenWork is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but VeloxOpenWork status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ and OPENCODE_ names are managed by VeloxOpenWork/OpenCode.",
  ...
  "memory.sign_in_hint": "Sign in to your VeloxOpenWork account to view your memory bank.",
  ...
  "settings.updates_desc": "Keep VeloxOpenWork up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an VeloxOpenWork host, then choose it from the list to import this skill.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected VeloxOpenWork server.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active VeloxOpenWork Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active VeloxOpenWork Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "VeloxOpenWork Cloud opens in your browser. Return here after signing in.",
  "skills.share_team_uploaded_success": "Uploaded to {org}. It will appear in Collections.",
  ...
  "status.limited_hint": "Reconnect to restore full VeloxOpenWork features",
  ...
  "status.openwork_ready": "VeloxOpenWork Ready",
  ...
  "system.reload_body_default": "VeloxOpenWork detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "VeloxOpenWork detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "VeloxOpenWork can't load tasks from this worker until the connection is fixed.",
