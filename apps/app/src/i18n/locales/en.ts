...
export default {
  ...
  "extensions.create_skill_hint": "Saved to your organization Library. Agents can load these instructions from OpenWork Cloud.",
  ...
  "extensions.add_plugin_collection_hint": "Publishing puts the plugin in the collection so members find it in the OpenWork app.",
  ...
  "extensions.add_unauthorized": "Your OpenWork Cloud session expired. Sign in again, then create the skill.",
  ...
  "mcp.managed_oauth_unavailable": "Secure storage is unavailable on this device, so OpenWork-managed sign-ins are paused.",
