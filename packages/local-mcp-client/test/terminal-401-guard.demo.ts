 ...
 * remote-mcp-terminal-401-guard). Drives the real createRemoteMcpClient
...
class DemoOAuthPersistence implements RemoteMcpOAuthPersistence {
  ...
  private readonly authorizationRecords = new Map<
    string,
    { handle: RemoteMcpOAuthAuthorizationHandle; codeVerifier: string }
  >()
...
type ActResult = {
  ...
  invalidationDiagnostics: RemoteMcpDiagnosticEvent[]
}
