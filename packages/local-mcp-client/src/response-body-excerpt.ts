...
export const REMOTE_MCP_RESPONSE_BODY_EXCERPT_CHARS = 2_000
...
export function redactedResponseBodyExcerpt(text: string, limit = REMOTE_MCP_RESPONSE_BODY_EXCERPT_CHARS): string {
...
export async function boundedRedactedResponseBodyExcerpt(
  response: Response,
  limit = REMOTE_MCP_RESPONSE_BODY_EXCERPT_CHARS,
